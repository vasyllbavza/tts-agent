...
#         await update.message.reply_text(help_text, disable_web_page_preview=True)
    ...
    async def tts(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        logging.info(f'tts fet text {update} ')
        if tts_query == '':
            await update.effective_message.reply_text(
                message_thread_id=get_thread_id(update),
    ...
    async def transcribeToText(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """
        ...
        async def _execute():
            ...
            try:
                ...
                if self.config['voice_reply_transcript'] and not response_to_transcription:
                    ...
                    # logging.info(f'Text User {transcript} ')
                    # textTranslite = localized_text(transcript, bot_language);

                    speech_file, text_length = await self.openai.generate_speech(text=transcript)
    ...
    async def prompt(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        speech_file, text_length = await self.openai.generate_speech(text=prompt)
